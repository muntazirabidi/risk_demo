...
function CapaRecommendations({ findings, companyName }) {
  ...
  const generateCapas = () => {
    ...
    findings.forEach((finding) => {
      if (finding.riskLevel === 'high' || finding.riskLevel === 'medium') {
        const capa = {
          id: `CAPA-${String(capaId).padStart(3, '0')}`,
          priority: finding.riskLevel.toUpperCase(),
          ...
          dueDate: calculateDueDate(finding.riskLevel),
  ...
  const calculateDueDate = (riskLevel) => {
    ...
    const daysToAdd = riskLevel === 'high' ? 30 : 90;
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-start justify-between mb-3">
                      ...
                      <button
                        ...
                        className="ml-4 text-teal-600 hover:text-teal-700 font-semibold text-sm transition-colors"
                      >
